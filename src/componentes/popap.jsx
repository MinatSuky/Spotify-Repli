...
export const Popap = ({ negacion }) => {
    ...
    return (
        <div onClick={negacion} className="absolute flex justify-end items-center right-[1px] w-[200vh] h-[100vh] z-10">
            <div className="cont1 bg-[black] rounded-tl-3xl w-[20vh] h-[100vh] shadaa">
                ...
                <Link to={"/"}>
                    <div className="flex justify-center mt-5 mx-7 bg-[#121212] py-3 rounded-md">
                ...
                <Link to={'/allbum'} >
                    <div className="flex justify-center mt-5 mx-7 bg-[#121212] py-3 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="50" height="45" color="#ffffff" fill="none">
