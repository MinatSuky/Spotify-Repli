...
export const Ultra = () => {
    ...
    const names = ["Cruel World", "Ultraviolence", "Shades of Cool", "Brooklyn Baby", "West Coast", "Sad Girl", "Pretty When You Cry", "Motext-sm Power Glory", "Fucked My Way Up to the Top", "Old Motext-sm", "The Other Woman", "This Is What Makes Us Girls",]

    const imgaudio = ["https://i1.sndcdn.com/artworks-000088937332-g0g4y7-t500x500.jpg", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKC-bCRNBiQkd9S_FzGad0ps3l6ksQnRUEnA&s", "https://upload.wikimedia.org/wikipedia/en/1/13/Lana_Del_Rey_-_Shades_of_Cool.png", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRyrmrgvPNs066dQzFdXAq_6WaRBMUU91G_kg&s", "https://i1.sndcdn.com/artworks-000125835697-xszs8m-t500x500.jpg", "https://i1.sndcdn.com/artworks-000595867989-fbyymu-t500x500.jpg", "https://i1.sndcdn.com/artworks-000119049113-3371ou-t500x500.jpg", "https://i1.sndcdn.com/artworks-000143874785-ruznid-t500x500.jpg", "https://i1.sndcdn.com/artworks-000442803108-ztelps-t500x500.jpg", "https://i.redd.it/xhpxsdqc5bd11.jpg", "https://static1.squarespace.com/static/5780595120099e05b57e23f0/t/586a4cb5b3db2ba53673a48d/1483361467395/?format=1500w", "https://i1.sndcdn.com/artworks-000229060031-nmj6di-t500x500.jpg"]
    ...
    return (
        <div className="padre flex gap-[3px]">
            ...
            <div className="h-[98.2vh] bg-[#121212] rounded-lg mt-2 overflow-auto hijo">
                <BarraPrin />
                <div className="fotoborn1 gradi ">
                    <div className="bg-[#323232]  portada p-8 ">

                        <div>
                            <img className="fotodie rounded-sm" src="https://i.scdn.co/image/ab67616d0000b2731624590458126fc8b8c64c2f" width={200} alt="" />
                        </div>
                        <div className="cursor-default">
                            <p className="text-white ml-3 font-medium ney all">Albunm</p>
                            <p className="text-white font-extrabold title-perfi2 ml-3">Ultraviolence</p>
                            <div className="text-white ml-3  mt-3  fechas2 gap-3">
                                <div className="fechas3">
                                    <img className="rounded-full" src={lanaR} alt="" width={30} />
                                    <p className="text-xl font-bold opacity-80">Lana Del Rey</p>
                                </div>
                                <div className="fechas">
                                    <p className="font-normal opacity-80 ney">2014</p>-
                                    <p className="font-normal opacity-80 ney">11 canciones, 47 min 05 s</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div onClick={() => toggleAudioPlayer(0)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div className="flex items-center gap-10">
                            <p>1</p>
                            <p className="text-white">Cruel World<br />
                    ...
                    <div onClick={() => toggleAudioPlayer(1)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div className="flex items-center gap-10">
                            <p>2</p>
                            <p className="text-white">Ultraviolence<br />
                                <span className="opacity-55 text-sm">Lana Del Rey</span></p>
                        </div>
                        <div className="flex  gap-24 cursor-default relative">
                    ...
                    <div onClick={() => toggleAudioPlayer(2)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div className="flex items-center gap-10">
                            <p>3</p>
                            <p className="text-white">Shades of Cool<br />
                                <span className="opacity-55 text-sm">Lana Del Rey</span></p>
                        </div>
                        <div className="flex  gap-24 cursor-default relative">
                    ...
                    <div onClick={() => toggleAudioPlayer(3)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div className="flex items-center gap-10">
                            <p>4</p>
                            <p className="text-white">Brooklyn Baby<br />
                                <span className="opacity-55 text-sm">Lana Del Rey</span></p>
                        </div>
                        <div className="flex  gap-24 cursor-default relative">
                    ...
                    <div onClick={() => toggleAudioPlayer(4)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div className="flex items-center gap-10">
                            <p>5</p>
                            <p className="text-white">West Coast<br />
                                <span className="opacity-55 text-sm">Lana Del Rey</span></p>
                        </div>
                        <div className="flex  gap-24 cursor-default relative">
                    ...
                    <div onClick={() => toggleAudioPlayer(5)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div className="flex items-center gap-10">
                            <p>6</p>
                            <p className="text-white">Sad Girl<br />
                                <span className="opacity-55 text-sm">Lana Del Rey</span></p>
                        </div>
                        <div className="flex  gap-24 cursor-default relative">
                    ...
                    <div onClick={() => toggleAudioPlayer(6)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div className="flex items-center gap-10">
                            <p>7</p>
                            <p className="text-white">Pretty When You Cry<br />
                                <span className="opacity-55 text-sm">Lana Del Rey</span></p>
                        </div>
                        <div className="flex  gap-24 cursor-default relative">
                    ...
                    <div onClick={() => toggleAudioPlayer(7)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div className="flex items-center gap-10">
                            <p>8</p>
                            <p className="text-white">Motext-sm Power Glory<br />
                                <span className="opacity-55 text-sm">Lana Del Rey</span></p>
                        </div>
                        <div className="flex  gap-24 cursor-default relative">
                    ...
                    <div onClick={() => toggleAudioPlayer(8)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div className="flex items-center gap-10">
                            <p>9</p>
                            <p className="text-white">Fucked My Way Up to the Top<br />
                                <span className="opacity-55 text-sm">Lana Del Rey</span></p>
                        </div>
                        <div className="flex  gap-24 cursor-default relative">
                    ...
                    <div onClick={() => toggleAudioPlayer(9)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div className="flex items-center gap-10">
                            <p>10</p>
                            <p className="text-white">Old Motext-sm<br />
                                <span className="opacity-55 text-sm">Lana Del Rey</span></p>
                        </div>
                        <div className="flex  gap-24 cursor-default relative">
                    ...
                    <div onClick={() => toggleAudioPlayer(10)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div className="flex items-center gap-10">
                            <p>11</p>
                            <p className="text-white">The Other Woman<br />
                                <span className="opacity-55 text-sm">Lana Del Rey</span></p>
                        </div>
                        <div className="flex  gap-24 cursor-default relative">
                ...
                <div className="overflow-hidden fixed z-[1] audicont">
                    ...
                    {barraAudio === 4 && <AudioPlayer imgaudio={imgaudio[4]} names={names[4]} audio={west} onEnded={handleEnded3} />}
                    ...
                    {barraAudio === 10 && <AudioPlayer imgaudio={imgaudio[10]} names={names[10]} audio={summe} />}
                </div>
            </div>
        </div>
    )
