...
import butty from "../audio/lanadelrey/butterfly.mp3"
import hope from "../audio/lanadelrey/hope.mp3"
...
export const Norman = () => {
    ...
    return (
        <div className="padre flex gap-[3px]">
            ...
            <BarraPrin />
                <div className="fotoborn3 gradi ">
                    <div className="bg-[#A31A21] portada p-8 ">
                        <div>
                            <img className="fotodie" src="https://i.scdn.co/image/ab67616d0000b273879e9318cb9f4e05ee552ac9" width={200} alt="" />
                        </div>
                        <div className="cursor-default">
                            <p className="text-white ml-3 font-medium ney all">Albunm</p>
                            <p className="text-white font-extrabold title-perfi1 ml-3">Norman Fucking Rockwell!</p>
                            <div className="text-white ml-3  mt-3 fechas2 gap-2">
                               ...
                               <p className="text-xl font-bold">Lana Del Rey</p>
                                ...
                                <p className="font-normal opacity-80 text-sm">2019</p>
                                <p className="font-normal opacity-80 text-sm">14 canciones, 1h 1 min 39 s</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div onClick={() => toggleAudioPlayer(12)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        ...
                        <div className="flex  gap-24 cursor-default relative">
                            <p className="opacity-60 repro">214.541.785</p>
                            <div className="mas">
                                <span onClick={() => setGuardado(!gurdado)} className="cursor-pointer" >
                                    {gurdado ?
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#ffffff" fill="none">
                    ...
                    <div onClick={() => toggleAudioPlayer(13)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        ...
                        <div className="flex  gap-24 cursor-default relative">
                            <p className="opacity-60 repro">145.785.325</p>
                            <div className="mas">
                                <span onClick={() => setGuardado(!gurdado)} className="cursor-pointer" >
                                    {gurdado ?
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#ffffff" fill="none">
                ...
                <div className="overflow-hidden fixed z-[1] audicont">
                    ...
                    {barraAudio === 12 && <AudioPlayer imgaudio={imgaudio[12]} names={names[12]} audio={butty} onEnded={handleEnded7} />}
                    {barraAudio === 13 && <AudioPlayer imgaudio={imgaudio[13]} names={names[13]} audio={hope}  />}
                </div>
            </div>
        </div>
    )
