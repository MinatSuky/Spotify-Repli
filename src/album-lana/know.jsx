...
import mar from "../audio/lanadelrey/Margaret.mp3"
import fil from "../audio/lanadelrey/Fishtail.mp3"
import pep from "../audio/lanadelrey/Peppers.mp3"
import taco from "../audio/lanadelrey/Taco.mp3"
...
export const Know = () => {
    ...
    const names = ["The Grant", "Did You Know That There’s a Tunnel Under Ocean Blvd", "SweeT", "A&W", "Judah Smith Interlude", "Candy Necklace", "Jon Batiste Interlude", "Kintsugi", "Fingertips", "Paris, Texas", "Grandfather", "Let The Light In", "Margaret", "Fishtail", "Peppers", "Taco Truck x VB"]

    const imgaudio = ["https://i.scdn.co/image/ab67616d0000b27311e3158d6de0e471bff44f6e", "https://upload.wikimedia.org/wikipedia/en/a/ae/Off_to_the_Races_cover.jpg", "https://upload.wikimedia.org/wikipedia/en/4/4e/LanaBlueJeans.png", "https://upload.wikimedia.org/wikipedia/en/c/cf/Lana_Del_Rey_-_Video_Games_single_cover.png", "https://i.pinimg.com/originals/de/31/e6/de31e663f873f03320eea57b0b228262.jpg", "https://i1.sndcdn.com/artworks-000071483784-1271k8-t500x500.jpg", "https://i1.sndcdn.com/artworks-000147467778-f96mnh-t500x500.jpg", "https://i1.sndcdn.com/artworks-000674063545-qt7x57-t500x500.jpg", "https://i1.sndcdn.com/artworks-000193290475-bmkipr-t500x500.jpg", "https://i1.sndcdn.com/artworks-000071611424-i1hhb6-t500x500.jpg", "https://is1-ssl.mzstatic.com/image/thumb/Music126/v4/2c/0b/d3/2c0bd3e6-f896-2555-210d-8957265c0a7a/21UM1IM42033.rgb.jpg/1200x1200bf-60.jpg", "https://i1.sndcdn.com/artworks-000229060031-nmj6di-t500x500.jpg", "https://lyricstranslate.com/files/d42d2eda38da3051000ae939b844b1cc_0.jpg", "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/a2172acc-9028-4653-9d6f-62d8f20ce9df/dg86psw-47f59c1b-7060-4f4e-bd06-669dec24c992.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..sVI6zJwZIMpmtLA8tkn4OUi-6zBVixNVDGs0Nrs2IZU", "https://i1.sndcdn.com/artworks-sueUxeXdURzSeQFL-9KJrng-t500x500.jpg", "https://i1.sndcdn.com/artworks-R31XVflpKt7Mwv0w-wi3VMg-t500x500.jpg"]
    ...
    return (
        <div className="padre flex gap-[3px]">
            ...
            <BarraPrin />
                <div className="fotoborn4 gradi">
                    <div className="bg-[#808227] portada p-8 ">
                        <div>
                            <img className="fotodie rounded-md" src="https://i.scdn.co/image/ab67616d0000b27359ae8cf65d498afdd5585634" width={200} alt="" />
                        </div>
                        <div className="cursor-default">
                            <p className="text-white ml-3 font-medium ney all">Albunm</p>
                            <p className="text-white font-extrabold title-perfi3 ml-3">Did You Know That There’s a Tunnel Under Ocean Blvd</p>
                            <div className="text-white ml-3  mt-3 fechas2 gap-2">
                               ...
                               <p className="text-xl font-bold">Lana Del Rey</p>
                                ...
                                <p className="font-normal opacity-80 text-sm">16 canciones, 1h 7 min 12 s</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="overflow-hidden fixed z-[1] audicont">
                    ...
                    {barraAudio === 12 && <AudioPlayer imgaudio={imgaudio[12]} names={names[12]} audio={mar} onEnded={handleEnded7} />}
                    {barraAudio === 13 && <AudioPlayer imgaudio={imgaudio[13]} names={names[13]} audio={fil} onEnded={handleEnded7} />}
                    {barraAudio === 14 && <AudioPlayer imgaudio={imgaudio[14]} names={names[14]} audio={pep} onEnded={handleEnded8} />}
                    {barraAudio === 15 && <AudioPlayer imgaudio={imgaudio[15]} names={names[15]} audio={taco} />}
                </div>
            </div>
        </div>
    )
