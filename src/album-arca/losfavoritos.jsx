...
export const Losfav = () => {
    ...
    const names = ["Atmósfera", "Se Supone", "Original", "Date Cuenta", "Mi Primer Kilo", "Corte, Porte y Elegancia", "Los 3", "Me Gusta", "Victoria", "En Su Boca", "Pa Morir Se Nace", "De La Renta", "Lo Que Sea", "Piernas en el Aire","Un Vacilon","Caribbean Air","Balanceate","El Granjero"]
    const art = ["Arcangel"]

    const imgaudio = ["https://i.scdn.co/image/ab67616d0000b27352ff352cd503ceddbaf1d533"]
    ...
    return (
        <div className="padre flex gap-[3px]">
            ...
            <BarraPrin/>
                <div className="fotoborn8 gradi">
                    <div className="bg-[#285359] portada p-8">
                        <div>
                            <img className="fotodie rounded-md" src="https://i.scdn.co/image/ab67616d0000b27352ff352cd503ceddbaf1d533" width={200} alt="" />
                        </div>
                        <div className="cursor-default">
                            <p className="text-white ml-3 font-medium ney all">Albunm</p>
                            <p className="text-white font-extrabold title-perfi2 ml-3">Los Favoritos</p>
                            <div className="text-white ml-3  mt-3 fecha2 gap-2">
                                <div className="fechas3">
                                <img className="rounded-full" src={arca} alt="" width={30} />
                                <p className="text-xl font-bold">Arcangel</p>
                                </div>
                               <div className="fechas">
                               <p className="font-normal opacity-80 text-sm">2015</p>-
                               <p className="font-normal opacity-80 text-sm">18 canciones, 1h 6 min 25 s</p>
                               </div>
                            </div>
                        </div>
                    </div>
