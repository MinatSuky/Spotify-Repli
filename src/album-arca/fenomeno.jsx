...
export const Fenomeno = () => {
    ...
    const names = ["Pa' Que la Pases Bien", "Por Amar a Ciegas", "Chica Virtual", "Agresivo 3", "Si Te Pegas", "Conmigo No Puede", "Ahi Eh", "Yo Te Enseño", "Nada Malo", "Ganas De Ti", "Si", "Enamorado de Ti", "I Got Flow", "Ta Bueno el Ambiente"]
    const art = ["Arcangel"]

    const imgaudio = ["https://n9.cl/1kk8m"]
            ...
            <div className="h-[98.2vh] bg-[#121212] rounded-lg mt-2 overflow-auto hijo">
                ...
                <div className="fotoborn5 gradi">
                    <div className="bg-[#76564F] portada p-8 ">
                        <div>
                            <img className="fotodie rounded-md" src="https://i.scdn.co/image/ab67616d0000b273294ea58a8ac4ae598c46d0b0" width={200} alt="" />
                        </div>
