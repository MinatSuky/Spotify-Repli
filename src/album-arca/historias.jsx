...
import paque from "../audio/arcangel/Mi Testimonio.mp3"
import ciegas from "../audio/arcangel/Al Volante.mp3"
...
import invicto from "../audio/arcangel/Invicto.mp3"
...
export const Historias = () => {
    ...
    const names = ["Mi Testimonio","Al Volante", "Rehén", "Ponte Bonita", "Infeliz", "Video Llamada", "Doble Cara", "Hábitos", "Llename de Luz", "No Salgo de Casa", "Sigues Con Él", "Capricornio", "Menomoria Rota", "Te Esperaré","Invicto"]
    const art = ["Arcangel"]

    const imgaudio = ["https://i.scdn.co/image/ab67616d00001e027ce7c833a19b3552c318f080"]
    ...
    return (
        <div className="padre flex gap-[3px]">
            ...
            <div className="h-[99vh] bg-[#121212] rounded-lg mt-1 overflow-auto hijo">
                <BarraPrin/>
                <div className="fotoborn6 gradi">
                    <div className="bg-[#c4c7cf] portada p-8 ">
                        <div>
                            <img className="fotodie rounded-md" src="https://i.scdn.co/image/ab67616d00001e027ce7c833a19b3552c318f080" width={200} alt="" />
                        </div>
                        <div className="cursor-default">
                            <p className="text-white ml-3 font-medium ney all">Albunm</p>
                            <p className="text-white font-extrabold title-perfi2 ml-3">Historias de un Capricornio</p>
                            <div className="text-white ml-3  mt-3 fechas2 gap-2">
                               ...
                               <p className="font-normal opacity-80 text-sm">14 canciones, 52 min 56 s</p>
                               </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-7 cursor-default">
                     ...
                     {/* namber #1 */}
                    <div className="conn mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        <div onClick={() => toggleAudioPlayer(0)} className="flex items-center gap-10 cursor-pointer">
                            <p>1</p>
                    ...
                    <div onClick={() => toggleAudioPlayer(14)} className="conn cursor-pointer mt-5 flex items-center justify-between py-2 px-5 rounded-lg hover:bg-[#272a2c] mx-[3.5%]">
                        ...
                        <div className="flex  gap-24 cursor-default relative">
                            <p className="opacity-60 repro">93.521.825</p>
                            <div className="mas">
                                <span onClick={() => setGuardado(!gurdado)} className="cursor-pointer" >
                                    {gurdado ?
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#ffffff" fill="none">
                ...
                <div className="overflow-hidden fixed z-[1] audicont">
                    ...
                    {barraAudio === 14 && <AudioPlayer imgaudio={imgaudio[0]} names={names[14]} audio={invicto} onEnded={handleEnded7} />}
                </div>
            </div>
        </div>
    )
