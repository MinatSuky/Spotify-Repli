...
export const Ares = () => {
    ...
    const imgaudio = ["https://i.scdn.co/image/ab67616d0000b273f48143b885b851f2d5978749"]
            ...
            <BarraPrin/>
                <div className="fotoborn7 gradi">
                    <div className="bg-[#8E7B49]  portada p-8 ">
                        <div>
                            <img className="fotodie rounded-md" src="https://i.scdn.co/image/ab67616d0000b273f48143b885b851f2d5978749" width={200} alt="" />
                        </div>
                        <div className="cursor-default">
                            <p className="text-white ml-3 font-medium ney all">Albunm</p>
                            <p className="text-white font-extrabold title-perfi2 ml-3">Ares</p>
                            <div className="text-white ml-3  mt-3 fechas2 gap-2">
                                ...
                                <p className="font-normal opacity-80 text-sm">2018</p>-
                                <p className="font-normal opacity-80 text-sm">18 canciones, 1h 9 min 25 s</p>
                                </div>
                            </div>
                        </div>
                    </div>
