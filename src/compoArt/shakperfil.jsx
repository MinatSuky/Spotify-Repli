...
import summe from "../audio/shakira/Shakira - Hips Dont Lie (Official 4K Video) ft. Wyclef Jean (1).mp3"
import beautiful from "../audio/shakira/KAROL G, Shakira - TQG (Official Video) (1).mp3"
import say from "../audio/shakira/ENE.mp3"
import west from "../audio/shakira/Shakira - Antologia (Stereo) (1).mp3"
import games from "../audio/shakira/biza.mp3"
...
export const ShakPerfil = () => {
    ...
    const names = ["Hips Don't Lie", "TQG", "Dia De Enero", "Antologia", "Shakira: Bzrp Music Sessions, Vol.53"]

    //variable para la imagen en la barra de audio
    const imgaudio = ["https://i.scdn.co/image/ab67616d0000b273c1b69751aa42e90b6ec0a299", "https://i.scdn.co/image/ab67616d0000b27382de1ca074ae63cb18fce335", "https://i.scdn.co/image/ab67616d0000b273f342e70aacda9d78cfb6ce7a", "https://i.scdn.co/image/ab67616d0000b273021b9779a9dbaa6a976edb2d", "https://i.scdn.co/image/ab67616d0000b2732b6d78c5a3f6247aa997b812"]

    return (
        <div className="BARRAPRINCIPAL1 text-white">
            <BarraPrin/>
            <div className="fotoperfil6 h-[47vh] bg-cover bg-center flex flex-col">
                <p className="text-white font-extrabold title-perfi mt-20 ml-3">Shakira</p>
                <p className="text-white ml-3 font-medium mt-3">64.951.354 oyentes mensuales</p>
            ...
            <Link className="w-[100%]" >
                    <div onClick={() => toggleAudioPlayer(5)} className="CONTENEDOR mb-10 hover:bg-[#1A1A1A] relative rounded-xl cursor-pointer w-fit p-4  ml-4 mt-10">
                        <img className="rounded-md" src="https://i.scdn.co/image/ab67616d0000b273021b9779a9dbaa6a976edb2d" width={200} alt="" />
                        <p className="text-white font-medium mt-4 ney">Pies Descalzos</p>
                        <div className="flex gap-3 opacity-60">
                            <p className="cans">1995</p>
                    ...
                    <Link className="w-[100%]" >
                    <div onClick={() => toggleAudioPlayer(6)} className="CONTENEDOR mb-10 hover:bg-[#1A1A1A] relative rounded-xl cursor-pointer w-fit p-4  ml-4 mt-10">
                        <img className="rounded-md" src="https://i.scdn.co/image/ab67616d0000b273d05d3aad30c5fb7614893cf5" width={200} alt="" />
                        <p className="text-white ney font-medium mt-4">El Dorado</p>
                       
                        <div className="flex gap-3 opacity-60">
                            <p className="cans">2017</p>
                            <p className="cans">13 Canciones</p>
                        </div>
                        {barraAudio === 6 && <AudioPlayerNexx />}
                    </div>
                    </Link>
                <Link className="w-[100%]" >
                    <div onClick={() => toggleAudioPlayer(7)} className="CONTENEDOR mb-10 hover:bg-[#1A1A1A] relative rounded-xl cursor-pointer w-fit p-4  ml-4 mt-10">
                        <img className="rounded-md" src="https://i.scdn.co/image/ab67616d0000b2731f400a1f4d821b00824cf58f" width={200} alt="" />
                        <p className="text-white ney font-medium mt-4">Laundry Server</p>
                       
                        <div className="flex gap-3 opacity-60">
                            <p className="cans">2001</p>
                            <p className="cans">13 Canciones</p>
                        </div>
                ...
                <Link className="w-[100%]" >
                    <div onClick={() => toggleAudioPlayer(8)} className="CONTENEDOR mb-10 hover:bg-[#1A1A1A] relative rounded-xl cursor-pointer w-fit p-4  ml-4 mt-10">
                        <img className="rounded-md" src="https://i.scdn.co/image/ab67616d0000b2734214ddc9e33e76de6a8ee888" width={200} alt="" />
                        <p className="text-white ney font-medium mt-4">Sale el Sol</p>
                       
                        <div className="flex gap-3 opacity-60">
                            <p className="cans">2010</p>
                ...
                <Link className="w-[100%]" >
                    <div onClick={() => toggleAudioPlayer(9)} className="CONTENEDOR mb-10 hover:bg-[#1A1A1A] relative rounded-xl cursor-pointer w-fit p-4  ml-4 mt-10">
                        <img className="rounded-md" src="https://i.scdn.co/image/ab67616d0000b273bfcff1dd252b22bba16a2a5d" width={200} alt="" />
                        <p className="text-white ney font-medium mt-4">Donde Estan Los...</p>
                       
                        <div className="flex gap-3 opacity-60">
                            <p className="cans">1998</p>
                            <p className="cans">11 Canciones</p>
                        </div>
                ...
                <Link className="w-[100%]" >
                    <div onClick={() => toggleAudioPlayer(10)} className="CONTENEDOR mb-10 hover:bg-[#1A1A1A] relative rounded-xl cursor-pointer w-fit p-4  ml-4 mt-10">
                        <img className="rounded-md" src="https://i.scdn.co/image/ab67616d0000b273f342e70aacda9d78cfb6ce7a" width={200} alt="" />
                        <p className="text-white ney font-medium mt-4">Fijación Oral</p>
                       
                        <div className="flex gap-3 opacity-60">
                            <p className="cans">2005</p>
